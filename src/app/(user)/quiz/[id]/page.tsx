        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            <div className="bg-amber-50 px-4 py-2 rounded-lg">
              ...
              <Link
                href={`/materi/detail/${quiz.materi_id}`}
          ...
          <p className="text-gray-600 mb-6">
            Uji pemahaman Anda tentang {quiz.materis.title} dengan menjawab
            pertanyaan-pertanyaan berikut.
          </p>
          <div className="flex justify-center">
            <Link
              href={`/quiz/${quiz.id}/start`}
              className="px-6 py-3 bg-amber-500 text-white font-semibold rounded-full hover:bg-amber-600 transition-colors duration-300"
            >
              Mulai Quiz
            </Link>
          </div>
          ...
          <div className="space-y-4">
            ...
            {quiz.questions.length > 2 && (
              <p className="text-center text-gray-500 italic">
                ...dan {quiz.questions.length - 2} soal lainnya
              </p>
            )}
          </div>
        </div>

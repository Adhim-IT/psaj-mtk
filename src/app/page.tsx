    ...
    <div className="bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="px-4 md:px-16 lg:px-32 py-16 overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="uppercase text-emerald-600 font-semibold text-sm md:text-base mb-3">
            ...
            <p className="text-gray-600 text-lg mb-8 max-w-lg">
              Temukan konsep, solusi, dan latihan interaktif untuk meningkatkan
              pemahamanmu!
            </p>
            <button
            ...
            >
              ...
              <p className="text-xl md:text-2xl font-medium">
                <span className="text-amber-500 font-bold">+10,000</span>{" "}
                Pengguna Aktif
              </p>
            </div>
          </div>
          ...
          <div className="relative flex justify-center mt-12 md:mt-0">
            ...
            >
              <Image
                src="/img/bg-orang.png"
                alt="Background"
                width={400}
                height={500}
                className="w-full object-cover absolute top-0 left-0 opacity-50"
              />
              <Image
                src="/img/orang.png"
                alt="Orang"
                width={400}
                height={500}
                className="relative w-full object-cover transform hover:scale-105 transition-transform duration-300"
              />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          ...
          >
            <Image
              ...
              width={450}
              height={600}
              className="max-w-md lg:max-w-lg xl:max-w-xl shadow-2xl rounded-lg"
            />
          </div>
          {/* Bagian Teks */}
          <div className="order-1 md:order-2" data-aos="fade-left">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 leading-tight">
              <span className="text-amber-500">
                Edukasi Matematika Interaktif
              </span>
              untuk meningkatkan pemahaman dan kecintaan terhadap angka.
            </h2>
            <p className="text-gray-600 text-lg mb-8 max-w-xl">
              MathEdu hadir untuk membantu siswa dan pengajar dalam memahami
              konsep matematika dengan cara yang lebih menyenangkan, inovatif,
              dan interaktif.
            </p>
            <button
      ...
      <section className="max-w-6xl mx-auto mb-16 px-6">
        <h2
          className="text-3xl text-center mb-12 text-emerald-600 relative"
          data-aos="fade-up"
        >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* For Students */}
          <div
            className="group space-y-4 p-6 rounded-lg border border-amber-200 bg-white shadow-md hover:shadow-2xl hover:-translate-y-2 transition-transform duration-300"
            data-aos="fade-right"
          >
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex gap-2 hover:text-amber-600 transition-colors duration-200">
                ...
                <p>
                  Mempermudah siswa dalam menemukan rumus matematika dari dasar
                  hingga lanjutan tanpa harus mencarinya di buku tebal.
                </p>
              </li>
              <li className="flex gap-2 hover:text-amber-600 transition-colors duration-200">
                <span className="text-amber-500">•</span>
                <p>
                  Menghemat waktu dengan kalkulator khusus untuk menghitung
                  langsung hasil dari rumus yang dimasukkan.
                </p>
              </li>
              <li className="flex gap-2 hover:text-amber-600 transition-colors duration-200">
                <span className="text-amber-500">•</span>
                <p>
                  Tersedia berbagai tingkat kesulitan kuis untuk melatih
                  pemahaman siswa secara berkala.
                </p>
              </li>
              <li className="flex gap-2 hover:text-amber-600 transition-colors duration-200">
                <span className="text-amber-500">•</span>
                <p>
                  Siswa dapat bertanya kapan saja jika mengalami kesulitan
                  memahami konsep atau menyelesaikan soal matematika.
                </p>
              </li>
              <li className="flex gap-2 hover:text-amber-600 transition-colors duration-200">
                <span className="text-amber-500">•</span>
                <p>
                  Pengalaman belajar yang tidak membosankan dengan fitur yang
                  interaktif.
                </p>
              </li>
            </ul>
          ...
          {/* For Teachers */}
          <div
            className="group space-y-4 p-6 rounded-lg border border-emerald-200 bg-white shadow-md hover:shadow-2xl hover:-translate-y-2 transition-transform duration-300"
            data-aos="fade-left"
          >
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex gap-2 hover:text-emerald-700 transition-colors duration-200">
                ...
                <p>
                  Guru dapat menggunakan koleksi rumus matematika di website ini
              ...
              <li className="flex gap-2 hover:text-emerald-700 transition-colors duration-200">
                <span className="text-emerald-600">•</span>
                <p>
                  Kalkulator khusus dapat digunakan untuk mengajarkan cara
                  penggunaan rumus secara langsung.
                </p>
              </li>
              <li className="flex gap-2 hover:text-emerald-700 transition-colors duration-200">
                <span className="text-emerald-600">•</span>
                <p>
                  Math AI dapat digunakan sebagai asisten untuk menjawab
                  pertanyaan siswa yang membutuhkan penjelasan tambahan.
                </p>
              </li>
              <li className="flex gap-2 hover:text-emerald-700 transition-colors duration-200">
                <span className="text-emerald-600">•</span>
                <p>
                  Guru bisa menghemat waktu dalam menyusun soal atau materi
                  dengan memanfaatkan rumus dan fitur-fitur di website ini.
                </p>
              </li>
            </ul>
          </div>
      ...
      <section className="mt-24 px-4 md:px-16 lg:px-32 py-16">
        <div className="container mx-auto text-center">
          ...
          >
            ...
            <span className="text-amber-500">MathEdu</span>
          </h2>
          <p
          ...
          <button
            id="show-more-btn"
            className="mt-12 px-8 py-3 bg-emerald-500 text-white font-semibold rounded-full hover:bg-emerald-600 transition-colors duration-300 block md:hidden"
            data-aos="fade-up"
            data-aos-delay="800"
          >
            Lihat Lebih
